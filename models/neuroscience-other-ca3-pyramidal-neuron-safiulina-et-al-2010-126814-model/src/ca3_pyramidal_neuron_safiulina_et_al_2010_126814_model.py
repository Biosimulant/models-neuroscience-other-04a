...
"""Auto-generated BioModule wrapper for CA3 pyramidal neuron (Safiulina et al. 2010).

Source: modeldb:126814
Original: https://modeldb.science/126814
Standard: other
...
class OtherCa3PyramidalNeuronSafiulinaEtAl2010(biosim.BioModule):
    """Placeholder BioModule wrapper for: CA3 pyramidal neuron (Safiulina et al. 2010).
    ...
    def __init__(self, model_path: str = "data/126814.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ca3PyramidalNeuronSafiulinaEtAl2010126814Model = OtherCa3PyramidalNeuronSafiulinaEtAl2010
