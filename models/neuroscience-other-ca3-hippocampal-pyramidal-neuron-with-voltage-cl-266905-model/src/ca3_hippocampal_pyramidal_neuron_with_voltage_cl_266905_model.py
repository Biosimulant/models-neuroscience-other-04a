...
"""Auto-generated BioModule wrapper for CA3 hippocampal pyramidal neuron with voltage-clamp intrinsic conductance data (Traub et al 1991).

Source: modeldb:266905
Original: https://modeldb.science/266905
Standard: other
...
class OtherCa3HippocampalPyramidalNeuronWithVoltageClamp(biosim.BioModule):
    """BioModule wrapper for: CA3 hippocampal pyramidal neuron with voltage-clamp intrinsic conductance data (Traub et al 1991)."""

    def __init__(self, model_path: str = "data/266905.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ca3HippocampalPyramidalNeuronWithVoltageCl266905Model = OtherCa3HippocampalPyramidalNeuronWithVoltageClamp
