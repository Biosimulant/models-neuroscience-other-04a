...
**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/144976)
**Standard**: other
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-other-ca1-pyramidal-neurons-osb144976-model/model.yaml
```
