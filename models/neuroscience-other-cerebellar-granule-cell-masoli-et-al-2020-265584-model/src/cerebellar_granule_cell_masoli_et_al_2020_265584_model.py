...
"""Auto-generated BioModule wrapper for Cerebellar granule cell (Masoli et al 2020).

Source: modeldb:265584
Original: https://modeldb.science/265584
Standard: other
...
class OtherCerebellarGranuleCellMasoliEtAl2020(biosim.BioModule):
    """Placeholder BioModule wrapper for: Cerebellar granule cell (Masoli et al 2020).
    ...
    def __init__(self, model_path: str = "data/265584.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CerebellarGranuleCellMasoliEtAl2020265584Model = OtherCerebellarGranuleCellMasoliEtAl2020
