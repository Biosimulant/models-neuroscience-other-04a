...
"""Auto-generated BioModule wrapper for Central Nervous System tadpole model in Matlab and NEURON-Python (Ferrario et al, 2021).

Source: modeldb:267146
Original: https://modeldb.science/267146
Standard: other
...
class OtherCentralNervousSystemTadpoleModelInMatlabAndNeuron(bsim.BioModule):
    """Placeholder BioModule wrapper for: Central Nervous System tadpole model in Matlab and NEURON-Python (Ferrario et al, 2021).
...
CentralNervousSystemTadpoleModelInMatlabA267146Model = OtherCentralNervousSystemTadpoleModelInMatlabAndNeuron
