...
"""Auto-generated BioModule wrapper for Cell signaling/ion channel variability effects on neuronal response (Anderson, Makadia, et al. 2015).

Source: modeldb:185300
Original: https://modeldb.science/185300
Standard: other
...
class OtherCellSignalingIonChannelVariabilityEffectsOnNeuronal(bsim.BioModule):
    """Placeholder BioModule wrapper for: Cell signaling/ion channel variability effects on neuronal response (Anderson, Makadia, et al. 2015).
...
CellSignalingIonChannelVariabilityEffectsO185300Model = OtherCellSignalingIonChannelVariabilityEffectsOnNeuronal
