#!/usr/bin/env python3
"""Run generated space: neuroscience-hippocampal-circuits-combo-0035."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-hippocampal-circuits-combo-0035')} duration={duration} tick_dt={tick_dt}")
