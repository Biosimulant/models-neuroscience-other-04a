#!/usr/bin/env python3
"""Run generated space: neuroscience-synaptic-plasticity-combo-0037."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-synaptic-plasticity-combo-0037')} duration={duration} tick_dt={tick_dt}")
