#!/usr/bin/env python3
"""Run generated space: neuroscience-basal-ganglia-dopamine-combo-0069."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-neuroscience-other-04a": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-basal-ganglia-dopamine-combo-0069')} duration={duration} tick_dt={tick_dt}")
