#!/usr/bin/env python3
"""Run generated space: neuroscience-synaptic-plasticity-combo-0038."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-synaptic-plasticity-combo-0038')} duration={duration} tick_dt={tick_dt}")
